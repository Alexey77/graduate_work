...
def upgrade() -> None:
    ...
    op.create_table('provider_accounts',
                    ...
                    sa.Column('provider_name', sa.Enum('YANDEX', 'GOOGLE', name='provider'), nullable=False),
                    sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
                    sa.Column('updated_at', sa.DateTime(timezone=True), nullable=False),
    ...
    op.create_index(op.f('ix_provider_accounts_id'), 'provider_accounts', ['id'], unique=True)
    op.create_index(op.f('ix_provider_accounts_id_social'), 'provider_accounts', ['id_social'], unique=True)
    ...
    op.create_index(op.f('ix_user_sessions_id_created_at'),
                    'user_sessions',
                    ['id', 'created_at'],
                    unique=True)
    op.create_index(op.f('ix_user_sessions_refresh_token_created_at'),
                    'user_sessions',
                    ['refresh_token',
                     'created_at'],
                    unique=True)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_sessions_refresh_token_created_at'), table_name='user_sessions')
    ...
    op.drop_index(op.f('ix_provider_accounts_id_social'), table_name='provider_accounts')
