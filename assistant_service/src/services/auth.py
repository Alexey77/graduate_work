...
from core.config import auth_service_settings, AuthServiceSettings
...
class AuthService:
    ...
    def _decode_token(self, token: str) -> User:
        try:
            ...
            raise HTTPException(status_code=http.HTTPStatus.UNAUTHORIZED, detail="Token expired")
    ...
    async def get_current_user(self, access_token: str, external_validation: bool = False) -> User:
